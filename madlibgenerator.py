...
#heading
Label(root,text='Mad Libs Generator \nHave Fun!',font='Times 30 bold',bg='navajowhite',fg='red').pack()
Label(root,text='Click Any One:',font='arial 20 bold',bg='darkorange').place(x=30,y=120)
#functions
def madlib1():
    ...
    print( food + ', the photographer said as the camera flashed! ' + name + ' and I had gone to ' + place +' to get our photos taken on my birthday. The first photo we really wanted was a picture of us dressed as ' + animals + ' pretending to be a ' + profession + '. When we saw the second photo, it was exactly what I wanted. We both looked like ' + things + ' wearing ' + cloth + ' and ' + verb + ' --exactly what I had in mind')
...
#buttons
Button(root,text='The Photographer',font='arial 15', command= madlib1, bg = 'ghost white').place(x=150, y=200)
Button(root, text= 'apple and apple', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=160, y=290)
Button(root, text= 'The Butterfly', font ='arial 15', command = madlib2, bg = 'ghost white').place(x=170, y=390)
